(function(){
  ...
  getLogsFbCollection = function(callback){
    return getMongoDb2(function(db){
      return callback(db.collection('fblogs10'), db);
    });
  };
  app = express();
  ...
  get_study1survey = function(req, res){
    return res.sendfile('study1survey.html');
  };
